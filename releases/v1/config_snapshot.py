...
DATA_PATCHES = PROJECT_ROOT / "data" / "patches"
...
# Egitimde kullanilacak bantlar. Baslangic icin RGB + NIR + SWIR + cirrus:
# bulut ayrimi icin en bilgi tasiyan alt kume. Tum bantlar icin: BANDS = S2_BANDS
